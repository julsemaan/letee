...
def _install_bindings(prefix: str, sidebar_pane: str, right_pane: str) -> None:
    ...
    tmux.tmux("bind-key", "r", "run-shell", f"{FOCUS_SIDEBAR} remove")
    tmux.tmux("bind-key", "x", "run-shell", f"{FOCUS_SIDEBAR} kill")
    tmux.tmux("bind-key", "!", "run-shell", f"{FOCUS_SIDEBAR} alert")
