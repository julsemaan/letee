...
- left-click inner window tabs: select the clicked window; click the `＋ add` button before the right-side status content to create and select a new window in the active pane's current directory (tmux 3.4+)
